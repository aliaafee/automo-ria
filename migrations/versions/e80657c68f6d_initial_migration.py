...
Revision ID: e80657c68f6d
Revises: 
Create Date: 2018-04-16 23:37:51.968384
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['drug_id'], [u'drug.id'], ),
    sa.ForeignKeyConstraint(['preset_id'], [u'presetprescription.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
